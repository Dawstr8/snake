            ...
            if self.mode == "taxi":
                ...
                if self.length < 60 * (grid_width * grid_height) / 100:
                    ...
                    for i in range(len(hamiltonian_cycle)):
                        ...
                        if hamiltonian_cycle[i] == food.position:
                            food_position = i
                    best_child = Node(food, self, None, (hamiltonian_cycle[(head+1)%(grid_width*grid_height)][0]-hamiltonian_cycle[head][0], hamiltonian_cycle[(head+1)%(grid_width*grid_height)][1] - hamiltonian_cycle[head][1]))
